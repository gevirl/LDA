...
public class Likelihood implements Callable<Double> {
    ...
    public Likelihood(int[][]docs,int[][]nw,int[][] nd,double alpha,double beta,int iter){
        this.alpha = alpha;
        this.beta = beta;
        this.nw = nw;
        this.nd = nd;
    ...
    static public double[][] phi(int[][] nw, double beta) {
        return phi(asDouble(nw), beta);
    }

    static public double[][] phi(double[][] nw, double beta) {
        // nw - VxK
        // phi - KXV
        // nwsum - K
    ...
    static public double[][] phi(double[][] nw, double[] nwsum, double beta) {
        int K = nw[0].length;
        int V = nw.length;
    ...
    static public double[][] theta(int[][] nd, double alpha) {
        return theta(asDouble(nd), alpha);
    }

    static public double[][] theta(double[][] nd, double alpha) {
        // nd = DxK
        // theta - DxK
        // ndsum - D
        int D = nd.length;
    ...
    static public double[][] theta(double[][] nd, double[] ndsum, double alpha) {
        int D = nd.length;
        int K = nd[0].length;
